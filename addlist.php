        ...
        <div class="addproduct">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <input type="number" class="form-control" name="sede" required> </div> <br>
                <div class="form-button">
                    <button type="submit" class="modify" style="float:right">Agregar registro</button>
